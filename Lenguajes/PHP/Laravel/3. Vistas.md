...
Si las vistas están dentro de un directorio dentro de **`resources/views/`** ej *users*, entonces para llamar a las vistas ya sea de las rutas o controladores hay que utilizar la sintaxis de punto
```php
 function () {
